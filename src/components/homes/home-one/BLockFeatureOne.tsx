      ...
      <div className="block-feature-one mt-130 xl-mt-100 lg-mt-80 mb-150 xl-mb-100 lg-mb-80">
         <div className="container">
            <div className="title-one text-center mb-50 xl-mb-30 lg-mb-20 wow fadeInUp">
               <h3>Explore Nutripath&apos;s <span>Core Benefits <Image src={titleShape} alt="" className="lazy-img" /></span></h3>
               <p className="fs-35">Your personal AI wellness guide—adapting to your mood, health goals, and lifestyle in real-time.</p>
            </div>
                  ...
                  .map((item) => (
                     <div key={item.id} className="col-md-4">
                        <div className="card-style-one text-center wow fadeInUp mt-40">
                           <Image src={item.icon ? item.icon : ""} alt={item.title} className="lazy-img m-auto icon" />
