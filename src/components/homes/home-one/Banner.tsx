...
const Banner = () => {
   return (
      <div className="hero-banner-one bg-pink z-1 pt-225 xl-pt-150 pb-250 xl-pb-150 lg-pb-100 position-relative">
                     ...
                     <div className="row">
                        <div className="col-xl-7 col-lg-12 col-md-7">
                           <p className="fs-24 color-dark m0 lg-pb-20 wow fadeInUp" data-wow-delay="0.1s">
                              Get custom diet plans, AI-powered insights, and real-time meal recommendations to help you stay on track.
                           </p>
                        </div>
                        <div className="col-xl-5 col-lg-12 col-md-5">
                           <div className="d-flex flex-column justify-content-center align-items-start">
                              <Image src={bannerImg_1} alt="NutriPath Dashboard" className="lazy-img" />
         ...
         <Image src={bannerThumb} alt="Nutrition Illustration" className="lazy-img shapes w-100 illustration" />
      </div>
   )
}
