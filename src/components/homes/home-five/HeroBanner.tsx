               ...
               <div className="row">
                  <div className="col-lg-7">
                     <div className="position-relative z-1">
                        <h1 className="hero-heading wow fadeInUp mb-50">We take care about your health</h1>
                        <Image src={bannerShape} alt="" className="lazy-img shape_01 shapes d-none d-lg-block" />
                        <div className="row">
                           <div className="col-xl-7 col-lg-12 col-md-7">
                              <p className="fs-24 color-dark m0 lg-pb-20 wow fadeInUp" data-wow-delay="0.1s">Make sure your daily nutrition is sufficient.Consult your problem aout nutrition with us</p>
                           </div>
