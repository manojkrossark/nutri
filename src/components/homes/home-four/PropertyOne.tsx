...
import nutir_1 from "@/assets/images/nutri_1.png";
      ...
      <div className="container container-large">
        <div className="position-relative">
          <div className="title-one mb-25 lg-mb-10 wow fadeInUp">
            <h3>
              Our Mission is to Advance the quality of nutirtion to everyone
            </h3>
          ...
          <div className="row gx-xxl-5">
            <Image src={nutir_1} alt="" className="lazy-img"></Image>
            {/* {property_data
