...
import footerLogo from "@/assets/images/logo/CromaAlto.png";
    ...
    <div className="footer-four position-relative z-1">
      <div className="container container-large">
            ...
            <div className="col-xxl-3 col-lg-4 mb-60">
              <div className="footer-intro">
                ...
                <p className="mb-30 xs-mb-20">
                  7094, Peachtree industrial Blvd., Suite 270 Norcross, GA
                  30071, USA
                </p>
        ...
        <div className="bottom-footer">
          <p className="m0 text-center fs-16">Copyright @2025 Krossark</p>
        </div>
      </div>
